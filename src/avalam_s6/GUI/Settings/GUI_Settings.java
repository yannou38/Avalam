...
public class GUI_Settings extends JPanel {
    ...
    private void initComponents() {
        ...
        this.leftLanguage.addMouseListener(new SettingsListener("left", theme, "language", this));
        ...
        this.leftFS.addMouseListener(new SettingsListener("left", theme, "fullscreen", this));
        ...
        this.leftTheme.addMouseListener(new SettingsListener("left", theme, "theme", this));
        ...
        this.leftSound.addMouseListener(new SettingsListener("left", theme, "sound", this));
        ...
        this.rightLanguage.addMouseListener(new SettingsListener("right", theme, "language", this));
        ...
        this.rightFS.addMouseListener(new SettingsListener("right", theme, "fullscreen", this));
        ...
        this.rightTheme.addMouseListener(new SettingsListener("right", theme, "theme", this));
        ...
        this.rightSound.addMouseListener(new SettingsListener("right", theme, "sound", this));
