...
public class LAG_AdapterListener implements ComponentListener {
    ...
    public void componentResized(ComponentEvent e) {
        ...
        page.getGrille().setBounds((int) round((640 + insets.left) * ratioW), ((int) round((240 + insets.top) * ratioH)), size.width, size.height);
        ...
        page.getUndoB().setBounds((int) round((600 + insets.left) * ratioW), ((int) round((930 + insets.top) * ratioH)), size.width, size.height);
        ...
        page.getRedoB().setBounds((int) round((1053 + insets.left) * ratioW), ((int) round((930 + insets.top) * ratioH)), size.width, size.height);
        ...
        page.getSaveB().setBounds((int) round((1650 + insets.left) * ratioW), ((int) round((930 + insets.top) * ratioH)), size.width, size.height);
        ...
        page.getRetourB().setBounds((int) round((4 + insets.left) * ratioW), ((int) round((930 + insets.top) * ratioH)), size.width, size.height);
