...
public class SettingsListener implements MouseListener {
    ...
    public SettingsListener(String buttonname, String relatedLabel, GUI_Settings page) {
        ...
        try {
            this.icon = ImageIO.read(new File("./ressources/Themes/" + SetupManager.getElement("Langue") + "/" + SetupManager.getElement("Theme") + "/options/" + this.name + "_h.png"));
            this.iconbase = ImageIO.read(new File("./ressources/Themes/" + SetupManager.getElement("Langue") + "/" + SetupManager.getElement("Theme") + "/options/" + this.name + ".png"));
        } catch (Exception ex) {
