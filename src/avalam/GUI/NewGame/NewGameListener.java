...
public class NewGameListener implements MouseListener {
    ...
    public NewGameListener(String buttonname, int playernumber, GUI_NewGame page, String type) {
        ...
        this.type = type;
        try {
            this.icon = ImageIO.read(new File("./ressources/Themes/" + SetupManager.getElement("Langue") + "/" + SetupManager.getElement("Theme") + "/playerselect/" + this.name + "_h.png"));
            this.iconbase = ImageIO.read(new File("./ressources/Themes/" + SetupManager.getElement("Langue") + "/" + SetupManager.getElement("Theme") + "/playerselect/" + this.name + ".png"));
        } catch (Exception ex) {
