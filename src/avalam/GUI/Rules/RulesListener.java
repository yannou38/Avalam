...
public class RulesListener implements MouseListener {
    ...
    public RulesListener(String buttonname) {
        ...
        try {
            this.icon = ImageIO.read(new File("./ressources/Themes/" + SetupManager.getElement("Langue") + "/" + SetupManager.getElement("Theme") + "/rules/" + this.name + "_h.png"));
            this.iconbase = ImageIO.read(new File("./ressources/Themes/" + SetupManager.getElement("Langue") + "/" + SetupManager.getElement("Theme") + "/rules/" + this.name + ".png"));
        } catch (Exception ex) {
